...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "Agent AI 可以與多家 LLM 提供商合作。這將是處理聊天的服務。",
    },
    userSetup: {
      title: "使用者設定",
    ...
    survey: {
      title: "歡迎使用 Agent AI",
      description: "幫助我們為您的需求打造 Agent AI。可選。",
      email: "您的電子郵件是什麼？",
      useCase: "您將如何使用 Agent AI？",
      useCaseWork: "用於工作",
      useCasePersonal: "用於個人使用",
      useCaseOther: "其他",
      comment: "您是如何聽說 Agent AI 的？",
      commentPlaceholder:
    ...
    workspace: {
      title: "創建您的第一個工作區",
      description: "創建您的第一個工作區並開始使用 Agent AI。",
    },
  },
  common: {
  ...
  api: {
    title: "API 金鑰",
    description:
      "API 金鑰允許持有者以程式化方式存取和管理此 Agent AI 系統。",
    link: "閱讀 API 文件",
  ...
  llm: {
    title: "LLM 偏好設定",
    description:
      "這些是您偏好的 LLM 對話與嵌入提供者的憑證和設定。確保這些金鑰是最新且正確的，否則 Agent AI 將無法正常運作。",
    provider: "LLM 提供者",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "語音轉錄提供者",
    "warn-start":
      "在記憶體或處理器資源有限的電腦上使用本機 Whisper 模型，處理媒體檔案時可能會造成 Agent AI 停頓。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是將文字轉換成向量的過程。這些憑證是用於將您的檔案和提示詞轉換成 Agent AI 可以處理的格式。",
    provider: {
      title: "向量嵌入提供者",
    },
  },
  ...
  vector: {
    title: "向量資料庫",
    description:
      "這些是您的 Agent AI 系統運作方式的憑證和設定。確保這些金鑰是最新且正確的，這點非常重要。",
    provider: {
      title: "向量資料庫提供者",
  ...
  privacy: {
    title: "隱私與資料處理",
    description:
      "這是您針對已連線的第三方供應商和 Agent AI 如何處理您的資料的設定。",
    llm: "LLM 選擇",
    embedding: "向量嵌入偏好設定",
    vector: "向量資料庫",
    anonymous: "已啟用匿名統計資訊",
  ...
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "擷取網站",
      "privacy-notice":
        "這些檔案將上傳到此 Agent AI 實例中的文件處理器。這些檔案不會發送或共享給第三方。",
    },
    pinning: {
      what_pinning: "什麼是文件固定？",
      pin_explained_block1:
        "當您在 Agent AI 中<b>固定</b>一個文件時，我們會將該文件的所有內容注入到您的提示窗口中，讓您的 LLM 完全理解。",
      pin_explained_block2:
        "這對於<b>大範圍模型</b>或對知識庫至關重要的小型文件效果最佳。",
      pin_explained_block3:
        "如果您沒有從 Agent AI 預設獲得理想的答案，那麼固定是一個輕鬆獲得更高質量答案的方法。",
      accept: "好的，明白了",
    },
    watching: {
      what_watching: "觀看文件有何作用？",
      watch_explained_block1:
        "當您在 Agent AI 中<b>觀看</b>一個文件時，我們會<i>自動</i>定期同步該文件的內容，並在每個管理該文件的工作區中自動更新內容。",
  ...
  customization: {
    interface: {
      title: "介面偏好設定",
      description: "設定你在 Agent AI 的使用介面偏好。",
    },
    branding: {
      title: "品牌與白標設定",
      description: "使用自訂品牌設計將 Agent AI 白標化。",
    },
    chat: {
      title: "聊天",
      description: "設定你在 Agent AI 的聊天偏好。",
      auto_submit: {
        title: "語音輸入自動送出",
    ...
    items: {
      ...
      "display-language": {
        title: "顯示語言",
        description: "選擇 Agent AI 使用者介面的顯示語言（如有提供翻譯）。",
      },
      logo: {
        title: "品牌標誌",
  ...
  "main-page": {
    ...
    checklist: {
      title: "開始使用",
      tasksLeft: "個任務未完成",
      completed: "你已經走在成為Agent AI專家的路上！",
      dismiss: "關閉",
      tasks: {
        create_workspace: {
          title: "建立工作空間",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "需要驗證",
          description:
            "在發布項目之前，您需要通過 Agent AI 社群中心進行驗證。",
          button: "連接到社群中心",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "密碼保護",
      description:
        "使用密碼保護您的 Agent AI 系統。如果您忘記這個密碼，將沒有復原方法，因此請務必儲存此密碼。",
      "password-label": "實例密碼",
    },
  },
  home: {
